...
## Synopsis: 
Exploring the usage of scooters around Washington D.C. region by geo-clustering and visualizing their movements through different periods of time. This unsupervised learning problem is set with over 8M observations of scooters which were converted to trips data to depict movement. We consider various models for clustering, and visulaize through geoplots. 

## Project motivation:
I was looking for interesting project ideas as a part of my mentorship program at SharpestMinds with Renkoh Kato who is a Senior Machine learning engineer at J.P. Morgan Chase. After exploring different ideas, I decided upon doing a project on this fast trending mode of transportation, e-scooters. I set out with these questions in mind:
...
-	If so, how can I generate insights to optimize placement of scooters? 
...
- Data was initially collected as CSVs and later transitioned to a PostgreSQL database using the sqlalchemy package.
- The collected data required extensive cleaning and preparation that I wouldnt go into too much detail here, but you can find an in-depth explanation of my whole project here (link to my blogpost)
